...
from whisper_timestamped.crisperwhisper.fallback import decode_with_coverage_fallback, word_count
from whisper_timestamped.crisperwhisper.longform.base import LongformConfig, make_chunks
from whisper_timestamped.crisperwhisper.longform.early_eot import (
...
if TYPE_CHECKING:
    from whisper_timestamped.crisperwhisper.interfaces import EngineProtocol
