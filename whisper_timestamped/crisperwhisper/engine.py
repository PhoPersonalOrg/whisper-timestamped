...
class CT2Engine:
    ...
    def _build_special_ids(self) -> None:
        ...
        from whisper_timestamped.crisperwhisper.prompt import PROMPT_MARKER_TOKENS
    ...
    def _init_feature_extractor(self) -> None:
        from whisper_timestamped.crisperwhisper.features import FeatureExtractor
    ...
    def generate_with_repair(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.hallucination import generate_with_repair
    ...
    def generate_with_repair_and_attention(
        ...
        *,
        ...
        """
        from whisper_timestamped.crisperwhisper.hallucination import generate_with_repair_and_attention
    ...
    def generate_dual_greedy(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.hallucination import (
