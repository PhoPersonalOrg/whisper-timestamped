...
from whisper_timestamped.crisperwhisper.audio import SAMPLE_RATE, get_duration, load_audio
from whisper_timestamped.crisperwhisper.result import TranscriptionResult
...
def _require_backend(backend: str) -> None:
    """Raise a helpful ImportError if a backend's dependencies are missing."""
    if not _backend_available(backend):
        ...
        raise ImportError(
            ...
            f"{', '.join(_BACKEND_MODULES[backend])}. "
            f"Install missing packages and retry."
        )
...
class CrisperWhisperModel:
    ...
    def __init__(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.version import detect_model_version
    ...
    def _init_v1(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.transformers_engine import TransformersEngine
    ...
    def _init_v2(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.converter import ensure_ct2_model
        from whisper_timestamped.crisperwhisper.engine import CT2Engine
    ...
    def _get_speculative_decoder(self, mode: str):
        ...
        if dec is None:
            from whisper_timestamped.crisperwhisper.speculative import SpeculativeDecoder
    ...
    def _validated_longform_config(
        *,
        ...
        """
        from whisper_timestamped.crisperwhisper.longform.base import EarlyEotConfig, LongformConfig
    ...
    def transcribe_dual(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.prompt import PromptBuilder
        ...
        if duration <= SHORT_THRESHOLD_S:
            ...
            from whisper_timestamped.crisperwhisper.longform.continuation import (
    ...
    def _transcribe_v1(
        ...
        *,
        ...
        """
        from whisper_timestamped.crisperwhisper.result import WordTimestamp
    ...
    def _transcribe_v1_chunk(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.word_timing import extract_word_timings
    ...
    def _transcribe_v2(
        ...
        *,
        ...
        from whisper_timestamped.crisperwhisper.longform.chunked_lcs import chunked_lcs_transcribe
        from whisper_timestamped.crisperwhisper.longform.continuation import (
            continuation_transcribe,
            continuation_transcribe_with_word_timestamps,
        )
        from whisper_timestamped.crisperwhisper.longform.token_lcs import token_lcs_transcribe
        from whisper_timestamped.crisperwhisper.prompt import PromptBuilder, strip_prompt_artifacts
        ...
        if duration <= SHORT_THRESHOLD_S:
            ...
            if word_timestamps and longform_strategy != "continuation":
                ...
                from whisper_timestamped.crisperwhisper.longform.chunked_lcs import (
                    chunked_lcs_transcribe_with_word_timestamps,
                )
                from whisper_timestamped.crisperwhisper.longform.token_lcs import (
                    token_lcs_transcribe_with_word_timestamps,
                )
    ...
    def forced_align(
        ...
        **transcribe-then-align** strategy: the audio is transcribed with the
        ...
        """
        from whisper_timestamped.crisperwhisper.forced_align import align_to_hypothesis
    ...
    def _transcribe_short(
        ...
        *,
        ...
        utterances <= 30s).
        """
        from whisper_timestamped.crisperwhisper.audio import SAMPLE_RATE as _SR
        from whisper_timestamped.crisperwhisper.fallback import decode_with_coverage_fallback
        from whisper_timestamped.crisperwhisper.prompt import strip_prompt_artifacts
        from whisper_timestamped.crisperwhisper.word_timing import extract_word_timings
    ...
    def _transcribe_short_dual(
        ...
        *,
        ...
        """
        from whisper_timestamped.crisperwhisper.audio import SAMPLE_RATE as _SR
        from whisper_timestamped.crisperwhisper.fallback import (
